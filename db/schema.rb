...
ActiveRecord::Schema.define(version: 20_180_102_030_631) do
  ...
  create_table 'lfg_posts', force: :cascade do |t|
    ...
    t.string 'platform'
    t.string 'checkpoint'
    t.index %w[user_id created_at], name: 'index_lfg_posts_on_user_id_and_created_at'
  ...
  create_table 'pgcrs', force: :cascade do |t|
    t.bigint 'character_id'
    t.integer 'mode'
    t.jsonb 'data'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['character_id'], name: 'index_pgcrs_on_character_id'
  end
  ...
  create_table 'votes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[voteable_id voteable_type], name: 'index_votes_on_voteable_id_and_voteable_type'
    t.index %w[voteable_type voteable_id], name: 'index_votes_on_voteable_type_and_voteable_id'
    t.index %w[voter_id voter_type voteable_id voteable_type], name: 'fk_one_vote_per_user_per_entity', unique: true
    t.index %w[voter_id voter_type], name: 'index_votes_on_voter_id_and_voter_type'
  ...
  add_foreign_key 'pgcrs', 'characters'
end
